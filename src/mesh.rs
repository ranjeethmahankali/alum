...
/**
 * A polygon mesh. `VecT` is the 3d vector type used to represent this mesh. The
 * positions of the vertices and face normals etc. are all `VecT`. Quantities
 * like edge length, face area etc. are of type `VecT::Scalar`. Various
    ...
    VecT: TVec<DIM>,
{
    ...
    /**
     * Create an empty mesh with memory reserved for the given number of elements.
     * The memory is also reserved for all the built-in properties. Normals are not computed.
     */
    ...
    /**
     * Reserve memory for the given number of elements. The memory is also reserved for all properties.
     */
    ...
    /**
     * Check if this vertex is valid for this mesh. It's index has to be less than the number of vertices.
     */
    ...
    /**
     * Check if this halfedge is valid for this mesh. It's index has to be less than the number of halfedges.
     */
    ...
    /**
     * Check if this edge is valid for this mesh. It's index has to be less than the number of edges.
     */
    ...
    /**
     * Check if the face is valid for this mesh. It's index has to be less than the number of faces.
     */
    ...
    /**
     * Get the vertex normals. It is `None` if the vertex normals are not available.
     */
     ...
     * returned. The vertex normals are not computed. The values in the property
